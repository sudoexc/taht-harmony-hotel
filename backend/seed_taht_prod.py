...
# ── справочники ───────────────────────────────────────────────────────────────
ROOMS = {  # номер: (этаж, тип, мест, базовая цена)
    '101': (1, 'SUITE',    2, 500_000),
    '102': (1, 'STANDARD', 2, 330_000),
    '103': (1, 'STANDARD', 2, 300_000),
    '204': (2, 'FAMILY',   3, 300_000),
    '205': (2, 'SUITE',    2, 450_000),
    '206': (2, 'ECONOM',   2, 280_000),
    '207': (2, 'STANDARD', 2, 330_000),
    '208': (2, 'STANDARD', 2, 300_000),
}
